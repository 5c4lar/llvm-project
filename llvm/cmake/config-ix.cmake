...
set(gtirb_FOUND 0)
if(LLVM_ENABLE_GTIRB)
  if(LLVM_ENABLE_GTIRB STREQUAL FORCE_ON)
    find_package(gtirb REQUIRED)
    if(NOT gtirb_FOUND)
      message(FATAL_ERROR "Failed to configure gtirb, but LLVM_ENABLE_GTIRB is FORCE_ON")
    endif()
  endif()
endif()
set(LLVM_ENABLE_GTIRB ${gtirb_FOUND})
